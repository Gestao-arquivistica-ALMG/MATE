...
with c2:
    st.markdown(
        ...
        <div style="
            ...
            height:56px;
        ">
        <a href="https://www.almg.gov.br/silegismg/login/login.jsp#/processos" target="_blank"
            title="Silegis">
        ...
        ">
          ...
          <a href="https://webmail.almg.gov.br/" target="_blank"
             ...
             style="
                ...
                border-radius:8px;
                font-size:22px;
             "><img src="https://media.istockphoto.com/id/1162427212/pt/vetorial/email-icon-flat-red-round-button-vector-illustration.jpg?s=612x612&w=0&k=20&c=hQI86uzzJFZukdsj5YVW0cV0QD1ceyj7ybOGlWVHiGo=" style="height:30px; weight:30px; display:block; transform:translateY(0px);"></a>
        ...
        components.html(
            ...
            <div style="margin:0 0 8px 0; display:flex; justify-content:flex-start;">
                <a href="javascript:void(0)" id="downloadExecPdf" style="text-decoration:none;">
                    <img src="{pdf_icon}" style="height:16px; vertical-align:middle; position:relative; top:-9px;">
                </a>
            </div>
