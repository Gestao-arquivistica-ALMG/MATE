...
if rodar:
    ...
    try:
        ...
        components.html(
        f"""
        <div style="font-family:Montserrat, sans-serif; margin-top:10px;">
          ...
          <div style="height:6px; background:#2a7de1; border-radius:4px; margin-bottom:12px;"></div>
          ...
          ">
            ...
            <a href="{url_com_aba}" target="_blank"
              style="
                padding:10px 18px;
                background:#e9e9e9;
                border-radius:8px;
            ...
            {"<a href='"+diario_url+"' target='_blank' style='padding:10px 18px;background:#e9e9e9;border-radius:8px;text-decoration:none;color:black;font-size:13px;'>Diário do Legislativo</a>" if diario_url else ""}

            <button id="openExecPdf"
              style="
                padding:10px 18px;
                background:#e9e9e9;
                border:none;
        ...
        document.getElementById("openExecPdf").onclick = () => {{
