...
def main(entrada_override=None, spreadsheet_url_or_id=None):
    ...
    STYLES = [
        ...
        # Cabeçalho
        ("A5:Y5", {"h": "CENTER", "v": "MIDDLE", "wrap": "CLIP", "font": "Vidaloka", "size": 10, "bold": True, "fg": "WHITE"}),
        ...
        ("E5:I5", {"font": "Fredericka the Great", "size": 12, "bold": False, "underline": False, "fg": "WHITE", "bg": "BLACK"}),
