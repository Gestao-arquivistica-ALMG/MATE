...
def main(entrada_override=None, spreadsheet_url_or_id=None, auth_mode="colab", sa_info=None):
    ...
    CUT_KEYS = {C_ATA, C_ATAS, C_COMUNICACOES, C_MATERIA_ADM, C_QUESTAO_ORDEM, C_PARTE_ORDEM_DIA, C_ENCERRAMENTO, C_SEGUNDA_FASE, C_DISCUSSAO_VOT_PROP, C_SUSPENSAO_REUNIAO, C_REABERTURA_REUNIAO, C_REGISTRO_PRESENCA,}
