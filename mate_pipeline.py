...
def main(entrada_override=None, spreadsheet_url_or_id=None, auth_mode="colab", sa_info=None):
    ...
    # ====================================================================================================================================================================================================
        data += [
            ...
            {"range": f"{tab_name}!W4", "values": [['=IFERROR(TEXT(QUERY(B6:G33;"SELECT B WHERE C MATCHES \'REQUERIMENTOS DE COMISSÕES\'";0);"\'dd mm yyyy\'");"")']]},
            {"range": f"{tab_name}!X3", "values": [['=IFERROR(TEXT(QUERY(B6:G33;"SELECT B WHERE C MATCHES \'REQUERIMENTOS DE COMISSÕES\'";0);"\'d m yyyy\'");"")']]},
            {"range": f"{tab_name}!X4", "values": [['=IFERROR(TEXT(QUERY(B6:G33;"SELECT B WHERE C MATCHES \'REQUERIMENTOS DE COMISSÕES\'";0);"dd/MM/yyyy");"")']]},
